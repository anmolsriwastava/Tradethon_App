...
FALLBACK_PUZZLES = [
    {
        ...
        "true_fair_value": 20,
        "hint_1": "Think about expected value: probability x outcome for each side",
        "hint_2": "EV = 0.6 x 100 + 0.4 x (-100) = 60 - 40 = 20"
    },
    {
        "title": "Dice Game",
        "description": "You roll a fair 6-sided die. You receive 10 x the number shown. What is the fair price to play?",
        "true_fair_value": 35,
        "hint_1": "Calculate the average payout across all outcomes",
        "hint_2": "EV = 10 x (1+2+3+4+5+6)/6 = 10 x 3.5 = 35"
    },
    {
        "title": "Card Draw",
        ...
        "hint_2": "12 face cards out of 52. EV = (12/52) x 200 = 46.15"
    },
    {
        "title": "Weighted Dice",
        ...
        "hint_2": "EV = (1/3)x60 + (2/3)x10 = 20 + 6.67 = 26.67"
    },
    {
        "title": "Urn Problem",
        ...
        "hint_2": "P(red) = 7/10 = 0.7. EV = 0.7 x 100 = 70"
    }
]


def generate_puzzle_with_claude() -> dict:
    try:
        ...
        message = client.messages.create(
            ...
            messages=[
                {
                    "role": "user",
                    "content": """Generate a probability trading puzzle for a quantitative finance game.
...
- Keep description under 60 words"""
        ...
        print("Claude API failed, using fallback puzzle:", e)
...
def get_puzzle() -> dict:
    ...
    if not api_key:
        ...
        return random.choice(FALLBACK_PUZZLES)
    return generate_puzzle_with_claude()